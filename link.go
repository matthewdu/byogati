...
type Link struct {
	...
	TrackingId    string `json:"trackingId" form:"trackingId" binding:"required"`
	HitType       string `json:"hitType" form:"hitType" binding:"required"`
	Title         string `json:"title" form:"title"`                 //pageview hit type
	Location      string `json:"location" form:"location"`           //pageview hit type
	EventCategory string `json:"eventCategory" form:"eventCategory"` //event hit type
	EventAction   string `json:"eventAction" form:"eventAction"`     //event hit type
	EventLabel    string `json:"eventLabel" form:"eventLabel"`       //event hit type
	EventValue    int    `json:"eventValue" form:"eventValue"`       //event hit type
	CustomPayload string `json:"customPayload" form:"customPayload"` //a user's custom generated hit type
